            ...
            <section id="aboutPageSec" className="p-30">
                <div id="aboutMainDiv" className="col-12">
                        ...
                        <div className="fontSize16 aboutText">
                            <img id="pierpaoloPic" className="mb-20 mr-20" src={`${RESOURCE_FOLDER}/Pierpaolo_DeGiosa_Foto_About.webp`} alt="Pierpaolo De Giosa Mareland"/>
                            ...
                            <p className="sctnHpTitles fontSize16 text-bold">Other Publications:</p>
                            <table>
                                <tbody>
                            ...
                            <p className="mt-10 mb-0">
                                Currently, Pierpaolo is a Marie Skłodowska-Curie Postdoctoral Fellow at the Department of Asian
                                Studies of Palacký University Olomouc (Czech Republic). For the MaReLand project he explores
                                land reclamation processes in Malaysia, the workings of sea-related environmentalism and activism, and
                                the politics of urban planning and compensation along the littoral.
                            </p>
                            <p className="mt-10 mb-0">You can get in touch with him via <u><span className="text-italic">pierpa.degios@zoho.com</span></u> or <u><span className="text-italic">pierpaolo.degiosa@upol.cz</span></u>.</p>
                        </div>
                </div>
            </section>
        </main>
